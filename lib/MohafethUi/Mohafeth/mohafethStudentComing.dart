...
class MohafethStudentComing extends StatelessWidget {
  String title;
  String number;
  String type;


  MohafethStudentComing(this.title,this.number, this.type, );
              ...
              children: [
                ...
                Row(
                  ...
                  children: [
                    ...
                    Text(type,style: TextStyle(fontSize: 20,color: Colors.grey),),
                  ],
                )
              ],
            ),
