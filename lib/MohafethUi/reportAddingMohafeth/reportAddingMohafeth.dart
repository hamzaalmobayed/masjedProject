...
class ReportAddingMohafeth extends StatefulWidget {
  Widget widget;
  Widget drawer;
  ReportAddingMohafeth(this.widget,this.drawer);

  @override
  _ReportAddingMohafethState createState() => _ReportAddingMohafethState();
}

class _ReportAddingMohafethState extends State<ReportAddingMohafeth> {
            ...
            children: [
              ...
              Padding(
                ...
                child: ElevatedButton(
                  onPressed: (){
                    Navigator.of(context).pushReplacement(MaterialPageRoute(builder: (context)=>PrintReport(ReportAddingMohafeth(Mohafeth(),MohafethDrawer()),MohafethDrawer())));
                  },
                  style: ButtonStyle(
