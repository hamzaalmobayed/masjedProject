...
class ShowPressedStudent extends StatefulWidget {
  Widget widget;
  Widget drawer;


  ShowPressedStudent(this.widget,this.drawer);

  @override
  _ShowPressedStudentState createState() => _ShowPressedStudentState();
}

class _ShowPressedStudentState extends State<ShowPressedStudent> {
                ...
                builder: (BuildContext context, AsyncSnapshot<QuerySnapshot> snapshot) {
                  ...
                  return Column(
                    children: snapshot.data.docs.map((DocumentSnapshot document) {
                      ...
                      if(name==(ProviderMasjed.pressedStudentName)){
                        return Column(
                          children: [
