...
import 'package:masjed/MohafethUi/examArcheive/examArcheive.dart';
...
import '../../main.dart';
class StudentArcheiveSearching extends StatelessWidget {
              ...
              children: [
                Container(
                  ...
                  child:Column(
                    ...
                    children: [
                      ProviderMasjed.studentChain==null? ReportShape("اسم الطالب","",[]): Column(
                          ...
                          Container(
                            ...
                            child: Padding(
                              ...
                              child: DropdownButton<Student_model>(
                                ...
                                iconSize: 30,
                                items: ProviderMasjed.studentChain.map((Student_model value) {
                                ...
                                onChanged: (v) {
                                  ProviderMasjed.selectStudentChain(v);
                                },
                                value: ProviderMasjed.selectedStudentChain,
                              ),
                            ),
                          )
                        ],
                      ),
                      ProviderMasjed.reportHistory==null? ReportShape("اختر التاريخ","",[]):Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          ...
                          Container(
                            ...
                            child: Padding(
                              ...
                              child: DropdownButton<Hefth_Model>(
                                ...
                                icon: Icon(Icons.keyboard_arrow_down_sharp,color: Colors.black,),
                                iconSize: 30,
                                items: ProviderMasjed.reportHistory.map((Hefth_Model value) {
                                ...
                                onChanged: (v) {
                                  ProviderMasjed.selectReportHistory(v);
                                },
                                value: ProviderMasjed.selectedReport,
                              ),
                            ),
                          )
                        ],
                ...
                Padding(
                  ...
                  child: ElevatedButton(
                    onPressed: () {
                      ...
                      Future.delayed(Duration(seconds: 3)).then((value) => Navigator.of(cont).pushReplacement(
                          MaterialPageRoute(
                              builder: (con) => ExamArchieve(StudentArcheiveSearching(),MohafethDrawer()))));
                    },
                    style: ButtonStyle(
